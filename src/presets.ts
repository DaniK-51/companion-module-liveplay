	...
	presets['stop_all'] = {
		...
		elements: [
			...
			},
			{
				...
				color: { isExpression: false, value: 0xffffff },
				fontsize: { isExpression: false, value: 44 },
				halign: { isExpression: false, value: 'center' },
		...
		feedbacks: [
			{
				...
				styleOverrides: [
					...
					},
					{
						elementId: 'label',
						elementProperty: 'text',
						override: { isExpression: false, value: 'SETUP' },
					},
				],
			},
		],
	...
	presets['play_next'] = {
		...
		elements: [
			...
			},
			{
				...
				text: {
					isExpression: true,
					value: '$(liveplay:effective_next_item_name) != "" ? $(liveplay:effective_next_item_name) : "Play Next"',
				},
				color: { isExpression: false, value: 0xffffff },
				fontsize: { isExpression: false, value: 18 },
				halign: { isExpression: false, value: 'center' },
